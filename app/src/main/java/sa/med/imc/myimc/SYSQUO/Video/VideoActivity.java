...
public class VideoActivity extends AppCompatActivity {
    ...
    private Button /*connectActionFab,*/ disconnect_action_fab, Button_VoiceLowHigh, BUtton_ChatEnable;
...
//------------------------------------------------------------------------------------------------//
    public void ServerToken(){
        ...
        viewModel.ConfRequ(token, conferenceJoiningRequestMode);
        viewModel.getVolumesResponseLiveData().observe(VideoActivity.this, response -> {

            if(response!=null){
                if(response.getStatus())
                {
                    SharedPreferencesUtils.getInstance(this).setValue(sa.med.imc.myimc.Network.Constants.KEY_VIDEO_ROOM_ID, String.valueOf(response.getData().getRoomId()));
                    roomID = response.getData().getRoomId();
                    ACCESS_TOKEN_SERVER = SharedPreferencesUtils.getInstance(VideoActivity.this).getValue(sa.med.imc.myimc.Network.Constants.KEY_VIDEO_ACCESS_TOKEN, null);
                    accessToken =  SharedPreferencesUtils.getInstance(VideoActivity.this).getValue(sa.med.imc.myimc.Network.Constants.KEY_VIDEO_ACCESS_TOKEN, null);
...
//------------------------------------------------------------------------------------------------//
    public void ExitRoom(){
        ...
        String token = SharedPreferencesUtils.getInstance(this).getValue(sa.med.imc.myimc.Network.Constants.KEY_ACCESS_TOKEN, null);
        viewModel.ExitRoom(token, exitRoomRequestModel);
        viewModel.getVolumesResponseLiveData().observe(VideoActivity.this, response -> {
...
//------------------------------------------------------------------------------------------------//
    public void ExitRoom2(){
        ...
        String token = SharedPreferencesUtils.getInstance(this).getValue(sa.med.imc.myimc.Network.Constants.KEY_ACCESS_TOKEN, null);
        viewModel.DisconnectRoom(token, disconnectRoomRequestModel);
        viewModel.getVolumesResponseLiveData().observe(VideoActivity.this, response -> {
...
//------------------------------------------------------------------------------------------------//
    public void LeaveEmergencyRoom(){
        ...
        String token = SharedPreferencesUtils.getInstance(this).getValue(sa.med.imc.myimc.Network.Constants.KEY_ACCESS_TOKEN, null);
        viewModel.LeaveEmergencyCall(token, leaveEmergencyCallRequestModel);
        viewModel.getVolumesResponseLiveData().observe(VideoActivity.this, response -> {
