...
public class CompletedBookingFragment extends Fragment implements BookingViews, BottomFilterBookingDialog.BottomDialogListener, ManageBookingsActivity.onFilterClick {
