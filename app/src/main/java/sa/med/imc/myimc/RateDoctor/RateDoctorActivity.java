...
public class RateDoctorActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        physician = (Booking) getIntent().getSerializableExtra("data");
            ...
            if (lang.equalsIgnoreCase(Constants.ARABIC)) {
                if (physician.getGivenNameAr() != null)
                    if (physician.getFamilyNameAr() != null)
                        tvPhysicianName.setText(Html.fromHtml(physician.getGivenNameAr() + " " + physician.getFamilyNameAr()));
                    else
                        tvPhysicianName.setText(Html.fromHtml(physician.getGivenNameAr()));
                ...
                if (physician.getGivenName() != null)
                    if (physician.getFamilyName() != null)
                        tvPhysicianName.setText(Html.fromHtml(physician.getGivenName() + " " + physician.getFamilyName()));
                    else
                        tvPhysicianName.setText(Html.fromHtml(physician.getGivenName()));
...
//                    Log.e("path  url  ", "" + url);
    ...
    public static void startActivity(Activity activity, Booking physician) {
            ...
            case R.id.lay_btn_submit:
                if (physician != null)
                    callRateDoctor(SharedPreferencesUtils.getInstance(this).getValue(Constants.KEY_ACCESS_TOKEN, ""),
                            ...
                            physician.getDocCode(), physician.getClinicCode(), String.valueOf(ratingBar.getRating()),
