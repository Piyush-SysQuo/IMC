...
public class EmergencyCallViewModel extends AndroidViewModel {
    ...
    public void EmergencyCall(String token, EmergencyCallRequestModel emergencyCallRequestModel) {

        emergencyCallRepository.emergencyCallAPI(token, emergencyCallRequestModel);
    }
