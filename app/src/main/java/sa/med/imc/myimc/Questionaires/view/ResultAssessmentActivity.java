...
import sa.med.imc.myimc.Questionaires.model.ResultModel;
...
public class ResultAssessmentActivity extends BaseActivity implements AssessmentViews {
    ...
    public void getResults(String id) {
        ...
        RequestBody body = RequestBody.create(okhttp3.MediaType.parse("text/plain; charset=utf-8"), id);
        ...
        xxx.enqueue(new Callback<ResultResponse>() {
            ...
            public void onResponse(Call<ResultResponse> call, Response<ResultResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response1 != null) {
                        if (response1.getResultModel() != null) {
                            if (response1.getResultModel().getTScore() != null) {
//                          layBtnViewReport.setVisibility(View.VISIBLE);
                                score = response1.getResultModel().getTScore();
                                resultModel = response1.getResultModel();
