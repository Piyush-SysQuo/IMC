...
public class ConferenceJoiningReqViewModel extends AndroidViewModel {
    ...
    public void ConfRequ(String token, ConferenceJoiningRequestMode conferenceJoiningRequestMode) {

        addBalanceRepository.serverTokenAPI(token, conferenceJoiningRequestMode);
    }
