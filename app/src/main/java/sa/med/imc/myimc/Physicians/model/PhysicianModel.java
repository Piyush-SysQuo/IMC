...
public class PhysicianModel implements Serializable {
    ...
    @SerializedName("publications_ar")
    @Expose
    private String publicationsAr;
    @SerializedName("a_c_highlights")
    @Expose
    private String aCHighlights;
    ...
    @SerializedName("a_c_highlights_Ar")
    @Expose
    private String aCHighlightsAr;
    ...
    public String getPublicationsAr() {
        return publicationsAr;
    }

    public void setPublicationsAr(String publicationsAr) {
        this.publicationsAr = publicationsAr;
    }

    public String getACHighlights() {
        return aCHighlights;
    }

    public void setACHighlights(String aCHighlights) {
        this.aCHighlights = aCHighlights;
    }
    ...
    public String getACHighlightsAr() {
        return aCHighlightsAr;
    }

    public void setACHighlightsAr(String aCHighlightsAr) {
        this.aCHighlightsAr = aCHighlightsAr;
    }
