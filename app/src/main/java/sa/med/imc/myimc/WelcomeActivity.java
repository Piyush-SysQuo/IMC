...
//        FacebookSdk.addLoggingBehavior(LoggingBehavior.APP_EVENTS);
    ...
    @OnClick({R.id.chatBot, R.id.lay_symtom_tracker, R.id.tv_login_guest, R.id.lay_virtual_family, R.id.lay_way_finder, R.id.lay_find_doctor, R.id.lay_health_byte, R.id.lay_departments, R.id.lay_main_fc, R.id.tv_sign_in, R.id.tv_register, R.id.lay_call_us, R.id.tv_english, R.id.tv_arabic, R.id.tv_english_new, R.id.tv_arabic_new})
...
//                HealthTipsActivity.startActivity(this);
    ...
    void showLocation() {
        ...
        if (SharedPreferencesUtils.getInstance(this).getValue(Constants.SELECTED_HOSPITAL, 0) == 1) {
