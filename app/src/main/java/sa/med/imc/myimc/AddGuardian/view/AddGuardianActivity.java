...
//            }
                ...
                if (tvButton.getText().toString().equalsIgnoreCase(getString(R.string.remove))) {
                    ...
                    if (response != null) {
                        if (rdUnlimited.isChecked())
                            callUpdateApi(response.getGuardianId(), 0);
                            ...
                            if (etNumberDays.getText().toString().isEmpty()) {
                                ...
                                callUpdateApi(response.getGuardianId(), Integer.parseInt(etNumberDays.getText().toString()));
                        }
    ...
    void callUpdateApi(String g_id, int noOfDays) {
