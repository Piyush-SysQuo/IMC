...
public class ClinicsAdapter extends RecyclerView.Adapter<ClinicsAdapter.Viewholder> {
    List<ClinicResponse.ClinicModel> list;
    List<ClinicResponse.ClinicModel> All_list;

    Context context;
    int pos_select = -1;
    String lang = Constants.ENGLISH;

    public ClinicsAdapter(Context context, List<ClinicResponse.ClinicModel> list) {
    ...
    public void onBindViewHolder(@NonNull Viewholder holder,  int position) {
        ...
        ClinicResponse.ClinicModel model = list.get(position);
        ...
        if (model.getId() != null) {
            String url = BuildConfig.IMAGE_UPLOAD_URL + model.getId() + ".png";
//            Log.e("clinic  ", "==== " + url);
