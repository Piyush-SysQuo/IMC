...
class LabReportContentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<LabReportsMedicus> items = new ArrayList<>();
    private OnItemClickListener onItemClickListener;
    private Context ll_context;

    public LabReportContentAdapter(Context ll_context, List<LabReportsMedicus> lstOfChildMedicus) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int pos) {
        ...
        LabReportsMedicus item = items.get(pos);
    ...
    static class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        // endregion
        public void bind(final LabReportsMedicus model, final OnItemClickListener listener) {
    ...
    public interface OnItemClickListener {
        void onItemClick(int position, LabReportsMedicus model);
