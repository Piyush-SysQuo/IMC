...
public interface ReportsPresenter {
    ...
    void callGetAllLabReports(String token, String mrn_number, String searc, String episodeId, String item_set, String page, String from, String to, int hosp);
    ...
    //TODO: add hop
    void callGenerateCardioPdf(String token, String mr_number, String attendanceId, String report_type);
