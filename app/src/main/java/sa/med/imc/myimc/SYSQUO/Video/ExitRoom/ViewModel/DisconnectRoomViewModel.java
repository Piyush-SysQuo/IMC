...
public class DisconnectRoomViewModel extends AndroidViewModel {
    ...
    public void DisconnectRoom(String token, DisconnectRoomRequestModel disconnectRoomRequestModel) {

        disconnectRoomRepository.disconnectRoomAPI(token, disconnectRoomRequestModel);
    }
