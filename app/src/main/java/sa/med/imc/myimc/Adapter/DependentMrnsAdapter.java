...
public class DependentMrnsAdapter extends RecyclerView.Adapter<DependentMrnsAdapter.Viewholder> {
    List<ValidateResponse.UserDetails> list;
    List<Integer> images;
    String lang = "";
    ...
    public DependentMrnsAdapter(Context context, List<ValidateResponse.UserDetails> list) {
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, final int position) {
        holder.tv_mrn.setText(list.get(position).getMrnumber());
