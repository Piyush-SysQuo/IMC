...
public class ChatAccessTokenViewModel extends AndroidViewModel {
    ...
    public void ChatAccessToken(String token, ChatAccessTokenRequetModel chatAccessTokenRequetModel) {

        chatAccessTokenRepository.chatAccessTokenAPI(token, chatAccessTokenRequetModel);
    }
