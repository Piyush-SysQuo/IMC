...
public class PhotoFullPopupWindow  extends PopupWindow {
    ...
    public PhotoFullPopupWindow(Context ctx, int layout, View v, String imageUrl, Bitmap bitmap) {
        super(((LayoutInflater) ctx.getSystemService(Service.LAYOUT_INFLATER_SERVICE)).inflate( R.layout.sysquo_popup_photo_full, null), ViewGroup.LayoutParams.MATCH_PARENT,
...
//            }
        ...
        else
        {
            ...
            Glide.with(ctx) .asBitmap()
                    ...
                    .error(R.drawable.sysquo_no_image)
