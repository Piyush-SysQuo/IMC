...
public class CancelledBookingAdapter extends RecyclerView.Adapter<CancelledBookingAdapter.Viewholder> {
    ...
    public CancelledBookingAdapter(Context context, List<Booking> list) {
    ...
    public Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.list_item_cancelled_booking, parent, false);
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, final int position) {
        ...
        if (booking.getDocImg() != null)
            if (booking.getDocImg().length() != 0) {
                ...
                Picasso.get().load(url).error(R.drawable.mdoc_placeholder)
