...
public class QuestionareActivity extends BaseActivity implements AssessmentViews {
    ...
    public static void startActivity(Activity activity, Booking booking) {
        Intent intent = new Intent(activity, QuestionareActivity.class);
...
//                SharedPreferencesUtils.getInstance(this).getValue(Constants.KEY_MRN, ""));
        ...
        getListForms(SharedPreferencesUtils.getInstance(this).getValue(Constants.KEY_ACCESS_TOKEN, ""),
                SharedPreferencesUtils.getInstance(this).getValue(Constants.KEY_MRN, ""),
                String.valueOf(booking.getSessionId()), String.valueOf(booking.getId()),
        ...
        switch (view.getId()) {
            ...
            case R.id.lay_btn_done:
                if (adapter.getSelected() > -1) {
                    ...
                    if (list.get(adapter.getSelected()).getAssessmentId() != null)
                        assessment_ID = list.get(adapter.getSelected()).getAssessmentId();
...
//                    }
    ...
    void setUpQuestionsRecyclerView() {
        ...
        adapter.setOnClickListener(new QuestionsAdapter.OnClickListener() {
            ...
            public void onChecked(int position) {
                if (list.get(position).getAssessmentId() != null)
    ...
    void setUpData() {
        list = new ArrayList<>();
//        list.addAll(booking.getPromisForm());
    }
    ...
    public void getListForms(String token, String mrNumber, String sessionId, String bookingId, int hosp) {
        Common.showDialog(this);
