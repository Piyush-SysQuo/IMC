...
public class SingleFragmentActivity extends BaseActivity implements FragmentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getStringExtra("type").equalsIgnoreCase(Constants.TYPE.REPORT_TYPE)) {
        ...
        } else if (getIntent().getStringExtra("type").equalsIgnoreCase(getString(R.string.bmi))) {
            // open BMI fragment
            startFragment(BMIFragment.newInstance("", ""));
        } else if (getIntent().getStringExtra("type").equalsIgnoreCase(getString(R.string.bmr))) {
            // open BMR fragment
            startFragment(BMRFragment.newInstance("", ""));
        } else if (getIntent().getStringExtra("type").equalsIgnoreCase(getString(R.string.ideal_body_weight))) {
            // open IBW fragment
            startFragment(IdealBodyWeightFragment.newInstance());
        } else if (getIntent().getStringExtra("type").equalsIgnoreCase(getString(R.string.medication))) {
