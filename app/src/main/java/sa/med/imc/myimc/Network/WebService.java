...
public interface WebService {
    ...
    @Multipart
    Call<SimpleResponse> registerPatient(@Part("user") RequestBody body,
                                         @Part MultipartBody.Part id_image);

    @POST(WebUrl.WEB_REGISTER)
    @Multipart
    Call<SimpleResponse> registerPatientWithIsurance(@Part("user") RequestBody body,
                                                     @Part MultipartBody.Part id_image,
    ...
    Call<CompaniesResponse> getInsuranceCompanies(@Path("hosp") int hosp);
    ...
    Call<PhysicianResponse> getAllDoctors(@Body RequestBody body);

    @POST(WebUrl.ALL_DOCTORS_WEB)
    Call<PhysicianResponse> getAllDoctorsWeb(@Body RequestBody body);
...
//    ======================Reports====================================
    ...
    Call<ResponseBody> fetchLabReportsMedicus(@Body RequestBody body);
...
//=============================================================================
    ...
    Call<AllergyResponse> fetchAllergies(@Path("mrn_number") String mrn_number, @Path("hosp") int hosp);

    @POST(WebUrl.GET_READINGS)
    Call<ReadingResponse> fetchAllReadings(@Body RequestBody body);
...
/*["pickupDob": , "copyType": email, "mrNumber": 000321, "reportTypeId": 30, "episodeType": OP,
 "pickupId": , "terms": 1, "message": Jk, "file": , "pickupName": , "episodeNo": 14143096, "infoCorrect": 1]*/
    @POST(WebUrl.REQUEST_FOR_REPORT)
    @Multipart
    Call<SimpleResponse> requestForReport( @Header("Accept-Language") String language,
                                           @Header("platform") String platform,
                                           @Header("Authorization") String token,
                                           @Header("isGuardian") String guardian,

                                          @Part("mrNumber") RequestBody mrNumber,
                                          @Part("episodeType") RequestBody episode,
                                          @Part("episodeNo") RequestBody episodeno,
                                          @Part("copyType") RequestBody copytype,
                                          @Part("message") RequestBody message,
                                          @Part("terms") RequestBody terms,
                                          @Part("pickupName") RequestBody pickup_name,
                                          @Part("pickupId") RequestBody pickup_id,
                                          @Part("pickupDob") RequestBody pickup_dob,
                                          @Part("infoCorrect") RequestBody info_correct,
  ...
  /*  @Multipart*//*@Header("Content-Type") String content,*/
    ...
    Call<ReportTypeResponse> getReportTypes(@Path("hosp") int hosp);

    @GET(WebUrl.GET_SELECT_VISIT)
   // Call<Select_TypeResponse> getSelecteVisit();
    Call<List<Select_TypeResponse>> getSelecteVisit(@Path("hosp") int hosp);
...
//    =============================Check In APIs==================================
    ...
    @POST(WebUrl.GET_PIN)
    Call<PinResponse> getPinForMedicus(@Body RequestBody body);
