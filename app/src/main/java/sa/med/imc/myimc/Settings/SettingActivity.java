...
public class SettingActivity extends BaseActivity {
    ...
    private void askLanguageChange() {
            ...
            if (SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.KEY_LANGUAGE, "").equalsIgnoreCase(Constants.ARABIC)) {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.KEY_LANGUAGE, "").equalsIgnoreCase(Constants.ENGLISH))
                            callChangeLanguage(SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.KEY_ACCESS_TOKEN, ""),
                                    SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.KEY_MRN, ""), Constants.ARABIC,
                                    SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.SELECTED_HOSPITAL, 0));
                        else if (SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.KEY_LANGUAGE, "").equalsIgnoreCase(Constants.ARABIC))
                            callChangeLanguage(SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.KEY_ACCESS_TOKEN, ""),
                                    SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.KEY_MRN, ""), Constants.ENGLISH,
                                    SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.SELECTED_HOSPITAL, 0));
                    }
                });
                ...
                builder.setPositiveButton("نعم", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.KEY_LANGUAGE, "").equalsIgnoreCase(Constants.ENGLISH))
                            callChangeLanguage(SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.KEY_ACCESS_TOKEN, ""),
                                    SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.KEY_USER_ID, ""), Constants.ARABIC,
                                    SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.SELECTED_HOSPITAL, 0));
                        else if (SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.KEY_LANGUAGE, "").equalsIgnoreCase(Constants.ARABIC))
                            callChangeLanguage(SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.KEY_ACCESS_TOKEN, ""),
                                    SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.KEY_USER_ID, ""), Constants.ENGLISH,
                                    SharedPreferencesUtils.getInstance(SettingActivity.this).getValue(Constants.SELECTED_HOSPITAL, 0));
                    }
                });
    ...
    // Call change language API
    public void callChangeLanguage(String token, String user_id, String language, int hosp) {
        // if user type guest then do not call API to send language to server.
        if (SharedPreferencesUtils.getInstance(this).getValue(Constants.KEY_USER_TYPE, "").equalsIgnoreCase(Constants.GUEST_TYPE)) {
            changeLanguageGuest(language);
        } else {
