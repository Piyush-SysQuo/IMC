...
//  ========================Auth APIs===========================
    ...
    String AUTH_VALIDATE = "auth/login/validate/";
    String AUTH_RESEND_OTP = "auth/resendotp/";
    String AUTH_UPDATE_CONSENT = "auth/update/constant/{mrNumber}/{constantValue}";
    String REG_VALIDATE = "selfReg/validate/";
    String REG_LOGIN = "selfReg/login/";
    ...
    String API_GET_USER = "api/user/userinfo/{userid}/{hosp}";
    ...
    String FETCH_LAB_REPORTS_MEDICUS = "api/labreports/find/V2";
    ...
    String REQUEST_FOR_REPORT = "api/requestReport";
    String GET_REPORT_TYPE = "api/reportType/fetch/{hosp}";
    ...
    String GET_SELECT_VISIT = "api/fetchepisodes/{hosp}";

    String RATE_DOCTOR = "api/physician/rate";
    String LOG_OUT = "api/user/logoutByDeviceID/{userid}/{deviceToken}/{hosp}";
    String GET_ALLERGIES = "api/patientAllergiesByMrn/{mrn_number}/{hosp}";
    String GET_READINGS = "api/vital/fetchVital/";
...
//  ==========================GUARDIAN APIs===============================
    ...
    String ADD_GUARDIAN = "api/guardian/link/";
    String GET_GUARDIAN = "api/guardian/getDetails/{MRN_NUMBER}/{hosp}";
    String REMOVE_GUARDIAN = "api/guardian/removeGuardian/";
...
//  ==========================Web  APIs===============================
    ...
    String CONTACT_US_NEW = "web/contactus";
...
//  ===================== CMS Departments and Doctors APIs =========================
    ...
    String API_START_ASSESSMENT = "api/promisAssessment/assessmentStart";
