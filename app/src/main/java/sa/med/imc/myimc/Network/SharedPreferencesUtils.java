...
//        db.clearAllTables();
        ...
        try {
            db.bookingDataDao().deleteData();
            db.labReportDataDao().deleteData();
            db.medicalReportDataDao().deleteData();
            db.sickLeaveDataDao().deleteData();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void setValue(String key, ValidateResponse.UserDetails value) {
        Gson gson = new Gson();
    ...
    public ValidateResponse.UserDetails getValue(String key) {
        Gson gson = new Gson();
        String json = preferences.getString(key, "");
        return gson.fromJson(json, ValidateResponse.UserDetails.class);
    }
