...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    private List<Select_TypeResponse> item;
    ...
    String ourdate;
    String app_date;
    public RecyclerViewAdapter(Context context, List<Select_TypeResponse> item) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        Log.i("autolog", "onBindViewHolder");
         ...
         app_date = item.get(position).getApptDate();
       // String serverdateFormat = "yyyy-MM-dd'T'HH:mm:ss.000+0000";
        ...
        {
            if (item.get(position).getConsultantAr() != null) {
                holder.name.setText(formatted + " - " + item.get(position).getEpisodeType() + " - " + item.get(position).getConsultant());
            }
            ...
            {
            if (item.get(position).getConsultant() != null) {
                holder.name.setText(formatted + " - " + item.get(position).getEpisodeType() + " - " + item.get(position).getConsultant());
            }
